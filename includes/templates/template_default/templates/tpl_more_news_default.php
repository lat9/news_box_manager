...
<div class="centerColumn" id="moreNewsDefault">
  ...
  <div class="newsInfo"><?php echo ($start_date === false) ? TEXT_NEWS_ARTICLE_NOT_FOUND : ('<span class="news_header">' . TEXT_NEWS_PUBLISHED_DATE . '</span><span class="news_date">' . $start_date . ((isset ($end_date)) ? ( NEWS_DATE_SEPARATOR . $end_date) : '') . '</span>'); ?></div>
